  ...
  module Internal
    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            Anthropic::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: Anthropic::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
      ...
      class << self
        # @api private
        sig do
          params(query: Anthropic::Internal::AnyHash).returns(
            Anthropic::Internal::AnyHash
          )
        end
        ...
        sig do
          params(
            collection: Anthropic::Internal::AnyHash,
            key: String,
            element: T.anything
          ).void
        end
