      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            Anthropic::Internal::Util::ParsedUriShape
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: Anthropic::Internal::Util::ParsedUriShape).returns(
            URI::Generic
          )
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[Anthropic::Internal::Util::ServerSentEvent]
          )
        end
