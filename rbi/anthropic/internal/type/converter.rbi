...
module Anthropic
  module Internal
    module Type
      # @api private
      module Converter
        Input = T.type_alias { T.any(Anthropic::Internal::Type::Converter, T::Class[T.anything]) }
        ...
        sig do
          overridable
            .params(value: T.anything, state: Anthropic::Internal::Type::Converter::CoerceState)
            .returns(T.anything)
        end
        ...
        sig do
          overridable
            .params(value: T.anything, state: Anthropic::Internal::Type::Converter::DumpState)
            .returns(T.anything)
        end
              ...
              spec: T.any(
                {
                  ...
                  enum: T.nilable(T.proc.returns(Anthropic::Internal::Type::Converter::Input)),
                  union: T.nilable(T.proc.returns(Anthropic::Internal::Type::Converter::Input))
                },
