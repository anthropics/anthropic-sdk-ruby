...
module Anthropic
  module Models
    BetaManagedAgentsReadToolConfigParams =
      Beta::BetaManagedAgentsReadToolConfigParams
    ...
    module Beta
      class BetaManagedAgentsReadToolConfigParams < Anthropic::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Anthropic::Beta::BetaManagedAgentsReadToolConfigParams::Type::OrSymbol
            )
          )
        end
        attr_reader :type
        ...
        module PermissionPolicy
          ...
          sig do
            override.returns(
              T::Array[
                Anthropic::Beta::BetaManagedAgentsReadToolConfigParams::PermissionPolicy::Variants
              ]
            )
          end
          def self.variants
          ...
          sig do
            params(
              type:
                Anthropic::Beta::BetaManagedAgentsReadToolConfigParams::PermissionPolicy::Type::OrSymbol
            ).returns(
              Anthropic::Beta::BetaManagedAgentsReadToolConfigParams::PermissionPolicy::Variants
            )
          end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Anthropic::Beta::BetaManagedAgentsReadToolConfigParams::Type
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          READ =
            T.let(
              :read,
              Anthropic::Beta::BetaManagedAgentsReadToolConfigParams::Type::TaggedSymbol
            )
