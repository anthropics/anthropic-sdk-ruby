...
module Anthropic
  module Models
    BetaManagedAgentsGlobToolConfigParams =
      Beta::BetaManagedAgentsGlobToolConfigParams
    ...
    module Beta
      class BetaManagedAgentsGlobToolConfigParams < Anthropic::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Anthropic::Beta::BetaManagedAgentsGlobToolConfigParams::Type::OrSymbol
            )
          )
        end
        attr_reader :type
        ...
        module PermissionPolicy
          ...
          sig do
            override.returns(
              T::Array[
                Anthropic::Beta::BetaManagedAgentsGlobToolConfigParams::PermissionPolicy::Variants
              ]
            )
          end
          def self.variants
          ...
          sig do
            params(
              type:
                Anthropic::Beta::BetaManagedAgentsGlobToolConfigParams::PermissionPolicy::Type::OrSymbol
            ).returns(
              Anthropic::Beta::BetaManagedAgentsGlobToolConfigParams::PermissionPolicy::Variants
            )
          end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Anthropic::Beta::BetaManagedAgentsGlobToolConfigParams::Type
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          GLOB =
            T.let(
              :glob,
              Anthropic::Beta::BetaManagedAgentsGlobToolConfigParams::Type::TaggedSymbol
            )
