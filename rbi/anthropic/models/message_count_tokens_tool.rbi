      ...
      class CodeExecutionTool20260120 < Anthropic::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Anthropic::MessageCountTokensTool::CodeExecutionTool20260120::AllowedCaller::OrSymbol
              ]
            )
          )
        end
        ...
        module AllowedCaller
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Anthropic::MessageCountTokensTool::CodeExecutionTool20260120::AllowedCaller
              )
            end
          ...
          DIRECT =
            T.let(
              :direct,
              Anthropic::MessageCountTokensTool::CodeExecutionTool20260120::AllowedCaller::TaggedSymbol
            )
      ...
      class WebSearchTool20260209 < Anthropic::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Anthropic::MessageCountTokensTool::WebSearchTool20260209::AllowedCaller::OrSymbol
              ]
            )
          )
        end
        ...
        sig do
          params(
            user_location:
              T.nilable(
                Anthropic::MessageCountTokensTool::WebSearchTool20260209::UserLocation::OrHash
              )
          ).void
        end
        ...
        module AllowedCaller
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Anthropic::MessageCountTokensTool::WebSearchTool20260209::AllowedCaller
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          DIRECT =
            T.let(
              :direct,
              Anthropic::MessageCountTokensTool::WebSearchTool20260209::AllowedCaller::TaggedSymbol
            )
          CODE_EXECUTION_20250825 =
            T.let(
              :code_execution_20250825,
      ...
      class WebFetchTool20260209 < Anthropic::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Anthropic::MessageCountTokensTool::WebFetchTool20260209::AllowedCaller::OrSymbol
              ]
            )
          )
        end
        ...
        module AllowedCaller
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Anthropic::MessageCountTokensTool::WebFetchTool20260209::AllowedCaller
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          DIRECT =
            T.let(
              :direct,
              Anthropic::MessageCountTokensTool::WebFetchTool20260209::AllowedCaller::TaggedSymbol
            )
          CODE_EXECUTION_20250825 =
            T.let(
              :code_execution_20250825,
