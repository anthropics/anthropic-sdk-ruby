...
module Anthropic
  module Internal
    ...
    module Util
      ...
      #   structure when using `Anthropic::Internal::Util.deep_merge`.
      #
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(Anthropic::Internal::Util::AnyHash, T::Array[T.anything], T.anything),
      ...
      class << self
        # @api private
        sig { params(url: T.any(URI::Generic, String)).returns(Anthropic::Internal::Util::ParsedUriShape) }
        def parse_uri(url)
        end

        # @api private
        sig { params(parsed: Anthropic::Internal::Util::ParsedUriShape).returns(URI::Generic) }
        ...
        sig do
          params(
            lhs: Anthropic::Internal::Util::ParsedUriShape,
            rhs: Anthropic::Internal::Util::ParsedUriShape
          )
            .returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig { params(lines: T::Enumerable[String]).returns(Anthropic::Internal::Util::ServerSentEvent) }
