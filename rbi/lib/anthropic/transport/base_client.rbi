...
module Anthropic
  module Transport
    ...
    class BaseClient
        ...
        T.type_alias do
          {
            ...
            page: T.nilable(T::Class[Anthropic::Type::BasePage[Anthropic::BaseModel]]),
            stream: T.nilable(T::Class[Anthropic::Type::BaseStream[T.anything, Anthropic::BaseModel]]),
            model: T.nilable(Anthropic::Type::Converter::Input),
      ...
      class << self
        # @api private
        sig { params(req: Anthropic::Transport::BaseClient::RequestComponentsShape).void }
        def validate!(req)
        end
        ...
        sig do
          params(
            request: Anthropic::Transport::BaseClient::RequestInputShape,
            status: Integer,
      ...
      # @api private
      sig { returns(Anthropic::Transport::PooledNetRequester) }
