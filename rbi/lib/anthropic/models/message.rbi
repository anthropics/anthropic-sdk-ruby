...
module Anthropic
  module Models
    class Message < Anthropic::BaseModel
      ...
      sig do
        params(_: T.nilable(Anthropic::Models::Message::StopReason::TaggedSymbol))
          .returns(T.nilable(Anthropic::Models::Message::StopReason::TaggedSymbol))
      end
      def stop_reason=(_)
      end
      ...
      sig do
        params(_: T.any(Anthropic::Models::Usage, Anthropic::Util::AnyHash))
          .returns(T.any(Anthropic::Models::Usage, Anthropic::Util::AnyHash))
      end
      def usage=(_)
      end
