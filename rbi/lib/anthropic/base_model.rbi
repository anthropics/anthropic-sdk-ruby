...
module Anthropic
  ...
  module Converter
    ...
    # @api private
    sig { overridable.params(value: T.anything, state: Anthropic::Converter::State).returns(T.anything) }
    ...
    class << self
          ...
          spec: T.any(
            {
              ...
              enum: T.nilable(T.proc.returns(Anthropic::Converter::Input)),
              union: T.nilable(T.proc.returns(Anthropic::Converter::Input))
            },
            T.proc.returns(Anthropic::Converter::Input),
      ...
      sig do
        params(target: Anthropic::Converter::Input, value: T.anything, state: Anthropic::Converter::State)
          .returns(T.anything)
      end
      def self.coerce(
        target,
      ...
      # @api private
      sig { params(target: Anthropic::Converter::Input, value: T.anything).returns(T.anything) }
  ...
  class Unknown
    ...
    class << self
      # @api private
      sig(:final) do
        override.params(value: T.anything, state: Anthropic::Converter::State).returns(T.anything)
      end
      def coerce(value, state:)
      end
  ...
  class BooleanModel
    ...
    class << self
      ...
      sig(:final) do
        override
          .params(value: T.any(T::Boolean, T.anything), state: Anthropic::Converter::State)
  ...
  module Enum
    ...
    sig do
      override
        .params(value: T.any(String, Symbol, T.anything), state: Anthropic::Converter::State)
  ...
  module Union
    ...
    sig { returns(T::Array[[T.nilable(Symbol), T.proc.returns(Anthropic::Converter::Input)]]) }
    ...
    sig do
      params(
        key: T.any(Symbol, Anthropic::Util::AnyHash, T.proc.returns(T.anything), T.anything),
        spec: T.any(Anthropic::Util::AnyHash, T.proc.returns(T.anything), T.anything)
      )
        .void
    end
    ...
    # @api private
    sig { override.params(value: T.anything, state: Anthropic::Converter::State).returns(T.anything) }
    def coerce(value, state:)
    end
  ...
  class ArrayOf
    ...
    sig(:final) do
      override
        .params(value: T.any(T::Enumerable[T.anything], T.anything), state: Anthropic::Converter::State)
  ...
  class HashOf
    ...
    sig(:final) do
      override
        .params(value: T.any(T::Hash[T.anything, T.anything], T.anything), state: Anthropic::Converter::State)
        .returns(T.any(Anthropic::Util::AnyHash, T.anything))
    end
    def coerce(value, state:)
    end
  ...
  class BaseModel
    ...
    class << self
        ...
        returns(
          T::Hash[Symbol,
                  T.all(
                    ...
                    {type_fn: T.proc.returns(Anthropic::Converter::Input)}
                  )]
        )
      end
      def known_fields
      ...
      sig do
        returns(
          T::Hash[Symbol, T.all(Anthropic::BaseModel::KnownFieldShape, {type: Anthropic::Converter::Input})]
        )
      end
      def fields
      end
      ...
      sig do
        override
          .params(
            ...
            state: Anthropic::Converter::State
          )
    ...
    sig { overridable.returns(Anthropic::Util::AnyHash) }
    def to_h
    end
    ...
    sig { params(keys: T.nilable(T::Array[Symbol])).returns(Anthropic::Util::AnyHash) }
