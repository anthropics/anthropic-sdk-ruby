...
module Anthropic
  ...
  module Util
    ...
    class << self
      ...
      sig do
        params(
          data: T.any(Anthropic::Util::AnyHash, T::Array[T.anything], T.anything),
    ...
    class << self
      # @api private
      sig { params(url: T.any(URI::Generic, String)).returns(Anthropic::Util::ParsedUriShape) }
      def parse_uri(url)
      end

      # @api private
      sig { params(parsed: Anthropic::Util::ParsedUriShape).returns(URI::Generic) }
      ...
      sig do
        params(
          lhs: Anthropic::Util::ParsedUriShape,
          rhs: Anthropic::Util::ParsedUriShape
        ).returns(URI::Generic)
      end
    ...
    class << self
      ...
      sig { params(lines: T::Enumerable[String]).returns(Anthropic::Util::ServerSentEvent) }
