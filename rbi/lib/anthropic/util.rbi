...
module Anthropic
  module Util
    ...
    sig do
      params(lhs: Anthropic::Util::ParsedUriShape, rhs: Anthropic::Util::ParsedUriShape).returns(URI::Generic)
    end
    ...
    sig { params(lines: T::Enumerable[String]).returns(Anthropic::Util::SSEMessage) }
