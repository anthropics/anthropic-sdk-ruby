...
module Anthropic
  module Type
    # @api private
    module Converter
      Input = T.type_alias { T.any(Anthropic::Type::Converter, T::Class[T.anything]) }
      ...
      # @api private
      sig do
        overridable.params(value: T.anything, state: Anthropic::Type::Converter::State).returns(T.anything)
      end
      ...
      class << self
            ...
            spec: T.any(
              {
                ...
                enum: T.nilable(T.proc.returns(Anthropic::Type::Converter::Input)),
                union: T.nilable(T.proc.returns(Anthropic::Type::Converter::Input))
              },
        ...
        sig do
          params(
            target: Anthropic::Type::Converter::Input,
            value: T.anything,
        ...
        # @api private
        sig { params(target: Anthropic::Type::Converter::Input, value: T.anything).returns(T.anything) }
