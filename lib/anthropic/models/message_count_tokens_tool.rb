...
module Anthropic
  module Models
    ...
    module MessageCountTokensTool
      ...
      variant -> { Anthropic::MessageCountTokensTool::CodeExecutionTool20260120 }
      ...
      variant -> { Anthropic::MessageCountTokensTool::WebSearchTool20260209 }

      variant -> { Anthropic::MessageCountTokensTool::WebFetchTool20260209 }
      ...
      class CodeExecutionTool20260120 < Anthropic::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Symbol, Anthropic::Models::MessageCountTokensTool::CodeExecutionTool20260120::AllowedCaller>, nil]
        optional :allowed_callers,
                 -> { Anthropic::Internal::Type::ArrayOf[enum: Anthropic::MessageCountTokensTool::CodeExecutionTool20260120::AllowedCaller] }
        ...
        #   {Anthropic::Models::MessageCountTokensTool::CodeExecutionTool20260120} for more
        #   details.
        #
        #   Code execution tool with REPL state persistence (daemon mode + gVisor
        #   checkpoint).
        #
        #   @param allowed_callers [Array<Symbol, Anthropic::Models::MessageCountTokensTool::CodeExecutionTool20260120::AllowedCaller>]
        #
      ...
      class WebSearchTool20260209 < Anthropic::Internal::Type::BaseModel
        ...
        # @!attribute allowed_callers
        #
        #   @return [Array<Symbol, Anthropic::Models::MessageCountTokensTool::WebSearchTool20260209::AllowedCaller>, nil]
        optional :allowed_callers,
                 -> { Anthropic::Internal::Type::ArrayOf[enum: Anthropic::MessageCountTokensTool::WebSearchTool20260209::AllowedCaller] }
        ...
        #   results.
        #
        #   @return [Anthropic::Models::MessageCountTokensTool::WebSearchTool20260209::UserLocation, nil]
        optional :user_location,
                 -> { Anthropic::MessageCountTokensTool::WebSearchTool20260209::UserLocation },
                 nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {Anthropic::Models::MessageCountTokensTool::WebSearchTool20260209} for more
        #   details.
        #
        #   @param allowed_callers [Array<Symbol, Anthropic::Models::MessageCountTokensTool::WebSearchTool20260209::AllowedCaller>]
        #
        ...
        #   @param strict [Boolean] When true, guarantees schema validation on tool names and inputs
        #
        #   @param user_location [Anthropic::Models::MessageCountTokensTool::WebSearchTool20260209::UserLocation, nil] Parameters for the user's location. Used to provide more relevant search results
        #
        ...
        # @see Anthropic::Models::MessageCountTokensTool::WebSearchTool20260209#user_location
        class UserLocation < Anthropic::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Anthropic::Models::MessageCountTokensTool::WebSearchTool20260209::UserLocation}
          #   for more details.
          #
          #   Parameters for the user's location. Used to provide more relevant search
          #   results.
      ...
      class WebFetchTool20260209 < Anthropic::Internal::Type::BaseModel
        ...
        # @!attribute allowed_callers
        #
        #   @return [Array<Symbol, Anthropic::Models::MessageCountTokensTool::WebFetchTool20260209::AllowedCaller>, nil]
        optional :allowed_callers,
                 -> { Anthropic::Internal::Type::ArrayOf[enum: Anthropic::MessageCountTokensTool::WebFetchTool20260209::AllowedCaller] }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Anthropic::Models::MessageCountTokensTool::WebFetchTool20260209} for more
        #   details.
        #
        #   @param allowed_callers [Array<Symbol, Anthropic::Models::MessageCountTokensTool::WebFetchTool20260209::AllowedCaller>]
        #
