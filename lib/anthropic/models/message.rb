...
module Anthropic
  module Models
    ...
    class Message < Anthropic::Internal::Type::BaseModel
      ...
      #   Some parameter documentations has been truncated, see {Anthropic::Message} for
      #   more details.
      #
      #   @param id [String] Unique object identifier.
      #
      #   @param content [Array<Anthropic::TextBlock, Anthropic::ToolUseBlock, Anthropic::ServerToolUseBlock, Anthropic::WebSearchToolResultBlock, Anthropic::ThinkingBlock, Anthropic::RedactedThinkingBlock>] Content generated by the model.
      #
      #   @param model [Symbol, String, Anthropic::Model] The model that will complete your prompt.\n\nSee [models](https://docs.anthropic
      #
      #   @param stop_reason [Symbol, Anthropic::StopReason, nil] The reason that we stopped.
      #
      #   @param stop_sequence [String, nil] Which custom stop sequence was generated, if any.
      #
      #   @param usage [Anthropic::Usage] Billing and rate-limit usage.
      #
