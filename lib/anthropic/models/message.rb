...
module Anthropic
  module Models
    class Message < BaseModel
      ...
      # Create a new instance of Message from a Hash of raw data.
      #
      # @overload initialize(id: nil, content: nil, model: nil, role: nil, stop_reason: nil, stop_sequence: nil, type: nil, usage: nil)
