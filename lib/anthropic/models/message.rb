...
module Anthropic
  module Models
    ...
    class Message < Anthropic::Internal::Type::BaseModel
      ...
      required :content, -> { Anthropic::Internal::Type::ArrayOf[union: Anthropic::Models::ContentBlock] }
      ...
      #   {Anthropic::Models::Message} for more details.
      #
      #   @param id [String] Unique object identifier. ...
      #
      #   @param content [Array<Anthropic::Models::TextBlock, Anthropic::Models::ToolUseBlock, Anthropic::Models::ThinkingBlock, Anthropic::Models::RedactedThinkingBlock>] Content generated by the model. ...
      #
      #   @param model [Symbol, String, Anthropic::Models::Model] The model that will complete your prompt.\n\nSee [models](https://docs.anthropic
      #   ...
      #
      #   @param stop_reason [Symbol, Anthropic::Models::StopReason, nil] The reason that we stopped. ...
      #
