...
module Anthropic
  module Models
    class TextEditorCodeExecutionViewResultBlockParam < Anthropic::Internal::Type::BaseModel
      ...
      # @!attribute file_type
      #
      #   @return [Symbol, Anthropic::Models::TextEditorCodeExecutionViewResultBlockParam::FileType]
      required :file_type, enum: -> { Anthropic::TextEditorCodeExecutionViewResultBlockParam::FileType }
      ...
      #   @param file_type [Symbol, Anthropic::Models::TextEditorCodeExecutionViewResultBlockParam::FileType]
      ...
      # @see Anthropic::Models::TextEditorCodeExecutionViewResultBlockParam#file_type
      module FileType
