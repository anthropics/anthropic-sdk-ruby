    ...
    module Beta
      module PromptCaching
        class PromptCachingBetaMessage < Anthropic::BaseModel
          ...
          #
          #   @return [Symbol, Anthropic::Models::Beta::PromptCaching::PromptCachingBetaMessage::Role]
          required :role, enum: -> { Anthropic::Models::Beta::PromptCaching::PromptCachingBetaMessage::Role }
          ...
          #
          #   @return [Symbol, Anthropic::Models::Beta::PromptCaching::PromptCachingBetaMessage::StopReason]
          required :stop_reason,
                   enum: -> { Anthropic::Models::Beta::PromptCaching::PromptCachingBetaMessage::StopReason }
          ...
          #
          #   @return [Symbol, Anthropic::Models::Beta::PromptCaching::PromptCachingBetaMessage::Type]
          required :type, enum: -> { Anthropic::Models::Beta::PromptCaching::PromptCachingBetaMessage::Type }
          ...
          #
          #   @return [Anthropic::Models::Beta::PromptCaching::PromptCachingBetaUsage]
          required :usage, -> { Anthropic::Models::Beta::PromptCaching::PromptCachingBetaUsage }
          ...
          #   #   For Messages, this is always `"message"`.
          #   #
          #   # @param usage [Anthropic::Models::Beta::PromptCaching::PromptCachingBetaUsage] Billing and rate-limit usage.
          #   #
      ...
      PromptCachingBetaMessage = PromptCaching::PromptCachingBetaMessage
    end
  end
end
