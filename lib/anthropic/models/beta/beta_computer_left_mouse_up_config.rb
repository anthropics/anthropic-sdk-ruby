...
module Anthropic
  module Models
    module Beta
      class BetaComputerLeftMouseUpConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerLeftMouseUpConfig} for more details.
        #
    ...
    BetaComputerLeftMouseUpConfig = Beta::BetaComputerLeftMouseUpConfig
  end
end
