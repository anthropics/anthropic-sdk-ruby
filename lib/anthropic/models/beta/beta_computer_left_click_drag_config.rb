...
module Anthropic
  module Models
    module Beta
      class BetaComputerLeftClickDragConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerLeftClickDragConfig} for more details.
        #
    ...
    BetaComputerLeftClickDragConfig = Beta::BetaComputerLeftClickDragConfig
  end
end
