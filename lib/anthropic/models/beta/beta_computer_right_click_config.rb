...
module Anthropic
  module Models
    module Beta
      class BetaComputerRightClickConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerRightClickConfig} for more details.
        #
    ...
    BetaComputerRightClickConfig = Beta::BetaComputerRightClickConfig
  end
end
