...
module Anthropic
  module Models
    module Beta
      class BetaBrowserReadConsoleConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserReadConsoleConfig} for more details.
        #
    ...
    BetaBrowserReadConsoleConfig = Beta::BetaBrowserReadConsoleConfig
  end
end
