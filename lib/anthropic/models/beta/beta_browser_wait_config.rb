...
module Anthropic
  module Models
    module Beta
      class BetaBrowserWaitConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserWaitConfig} for more details.
        #
    ...
    BetaBrowserWaitConfig = Beta::BetaBrowserWaitConfig
  end
end
