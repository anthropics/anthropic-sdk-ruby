...
module Anthropic
  module Models
    module Beta
      class BetaBrowserNavigateConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserNavigateConfig} for more details.
        #
    ...
    BetaBrowserNavigateConfig = Beta::BetaBrowserNavigateConfig
  end
end
