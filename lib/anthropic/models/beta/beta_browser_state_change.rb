  ...
  module Models
    module Beta
      ...
      module BetaBrowserStateChange
        ...
        variant :tab_opened, -> { Anthropic::Beta::BetaBrowserStateChangeTabOpened }

        # A file download that started during this call.
        variant :download_started, -> { Anthropic::Beta::BetaBrowserStateChangeDownloadStarted }

        # A file download that finished during this call, reported with the
        # same `download_id` as its `download_started` — or without a prior
        # `download_started`, when the download finished during the call that
        # started it (at most one state change per `download_id` per result).
        variant :download_completed, -> { Anthropic::Beta::BetaBrowserStateChangeDownloadCompleted }

        # A file download that failed — or was cancelled — during this call.
        variant :download_failed, -> { Anthropic::Beta::BetaBrowserStateChangeDownloadFailed }

        # @!method self.variants
        #   @return [Array(Anthropic::Models::Beta::BetaBrowserStateChangeTabOpened, Anthropic::Models::Beta::BetaBrowserStateChangeDownloadStarted, Anthropic::Models::Beta::BetaBrowserStateChangeDownloadCompleted, Anthropic::Models::Beta::BetaBrowserStateChangeDownloadFailed)]
        ...
        #
        # @raise [ArgumentError]
        # @return [Anthropic::Models::Beta::BetaBrowserStateChangeTabOpened, Anthropic::Models::Beta::BetaBrowserStateChangeDownloadStarted, Anthropic::Models::Beta::BetaBrowserStateChangeDownloadCompleted, Anthropic::Models::Beta::BetaBrowserStateChangeDownloadFailed]
