...
module Anthropic
  module Models
    module Beta
      class BetaComputerHoldKeyConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerHoldKeyConfig} for more details.
        #
    ...
    BetaComputerHoldKeyConfig = Beta::BetaComputerHoldKeyConfig
  end
end
