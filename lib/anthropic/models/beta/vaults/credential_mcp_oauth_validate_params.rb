  ...
  module Models
    module Beta
      module Vaults
        ...
        class CredentialMCPOAuthValidateParams < Anthropic::Internal::Type::BaseModel
          ...
          # @!method initialize(vault_id:, credential_id:, betas: nil, workspace_id: nil, request_options: {})
