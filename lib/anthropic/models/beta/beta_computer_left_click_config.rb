...
module Anthropic
  module Models
    module Beta
      class BetaComputerLeftClickConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerLeftClickConfig} for more details.
        #
    ...
    BetaComputerLeftClickConfig = Beta::BetaComputerLeftClickConfig
  end
end
