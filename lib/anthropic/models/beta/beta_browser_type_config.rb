...
module Anthropic
  module Models
    module Beta
      class BetaBrowserTypeConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserTypeConfig} for more details.
        #
    ...
    BetaBrowserTypeConfig = Beta::BetaBrowserTypeConfig
  end
end
