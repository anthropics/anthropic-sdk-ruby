  ...
  module Models
    module Beta
      class BetaWebFetchTool20250910 < Anthropic::Internal::Type::BaseModel
        ...
        # @!method initialize(allowed_callers: nil, allowed_domains: nil, blocked_domains: nil, cache_control: nil, citations: nil, defer_loading: nil, max_content_tokens: nil, max_uses: nil, strict: nil, url_sources: nil, name: :web_fetch, type: :web_fetch_20250910)
