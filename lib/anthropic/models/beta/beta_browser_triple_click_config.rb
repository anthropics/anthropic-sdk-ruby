...
module Anthropic
  module Models
    module Beta
      class BetaBrowserTripleClickConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserTripleClickConfig} for more details.
        #
    ...
    BetaBrowserTripleClickConfig = Beta::BetaBrowserTripleClickConfig
  end
end
