...
module Anthropic
  module Models
    module Beta
      class BetaBrowserListTabsConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserListTabsConfig} for more details.
        #
    ...
    BetaBrowserListTabsConfig = Beta::BetaBrowserListTabsConfig
  end
end
