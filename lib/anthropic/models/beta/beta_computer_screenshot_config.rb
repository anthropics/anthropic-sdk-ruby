...
module Anthropic
  module Models
    module Beta
      class BetaComputerScreenshotConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerScreenshotConfig} for more details.
        #
    ...
    BetaComputerScreenshotConfig = Beta::BetaComputerScreenshotConfig
  end
end
