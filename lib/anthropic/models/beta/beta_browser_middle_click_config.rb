...
module Anthropic
  module Models
    module Beta
      class BetaBrowserMiddleClickConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserMiddleClickConfig} for more details.
        #
    ...
    BetaBrowserMiddleClickConfig = Beta::BetaBrowserMiddleClickConfig
  end
end
