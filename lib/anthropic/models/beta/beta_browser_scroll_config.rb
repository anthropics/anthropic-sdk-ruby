...
module Anthropic
  module Models
    module Beta
      class BetaBrowserScrollConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserScrollConfig} for more details.
        #
    ...
    BetaBrowserScrollConfig = Beta::BetaBrowserScrollConfig
  end
end
