...
module Anthropic
  module Models
    module Beta
      class BetaBrowserStateChangeDownloadStarted < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserStateChangeDownloadStarted} for more
        #   details.
        #
    ...
    BetaBrowserStateChangeDownloadStarted = Beta::BetaBrowserStateChangeDownloadStarted
  end
end
