  ...
  module Models
    module Beta
      class BetaWebSearchToolResultBlockParam < Anthropic::Internal::Type::BaseModel
        # @!attribute content
        #
        #   @return [Array<Anthropic::Beta::BetaWebSearchResultBlockParam>, Anthropic::Beta::BetaWebSearchToolRequestError]
        ...
        #   @param content [Array<Anthropic::Beta::BetaWebSearchResultBlockParam>, Anthropic::Beta::BetaWebSearchToolRequestError]
        #
