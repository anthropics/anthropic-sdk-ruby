...
module Anthropic
  module Models
    module Beta
      class BetaBrowserScreenshotConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserScreenshotConfig} for more details.
        #
    ...
    BetaBrowserScreenshotConfig = Beta::BetaBrowserScreenshotConfig
  end
end
