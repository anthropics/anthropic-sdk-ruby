    ...
    module Beta
      class BetaManagedAgentsSessionThreadAgent < Anthropic::Internal::Type::BaseModel
        ...
        module Skill
          ...
          #
          # @param type [Symbol, Anthropic::Models::Beta::BetaManagedAgentsSessionThreadAgent::Skill::Type, String]
          #
        ...
        module Tool
          ...
          # value, passing the remaining arguments to its constructor.
          #
          # @param type [Symbol, Anthropic::Models::Beta::BetaManagedAgentsSessionThreadAgent::Tool::Type, String]
          #
          # @param args [Hash{Symbol=>Object}] Attributes for the chosen variant.
          #
