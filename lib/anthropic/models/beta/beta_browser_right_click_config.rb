...
module Anthropic
  module Models
    module Beta
      class BetaBrowserRightClickConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserRightClickConfig} for more details.
        #
    ...
    BetaBrowserRightClickConfig = Beta::BetaBrowserRightClickConfig
  end
end
