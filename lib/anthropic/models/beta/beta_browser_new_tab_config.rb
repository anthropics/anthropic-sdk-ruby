...
module Anthropic
  module Models
    module Beta
      class BetaBrowserNewTabConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserNewTabConfig} for more details.
        #
    ...
    BetaBrowserNewTabConfig = Beta::BetaBrowserNewTabConfig
  end
end
