    ...
    module Beta
      class BetaManagedAgentsAgentToolsetDefaultConfigParams < Anthropic::Internal::Type::BaseModel
        ...
        optional :permission_policy,
                 union: -> {
                   Anthropic::Beta::BetaManagedAgentsAgentToolsetDefaultConfigParams::PermissionPolicy
                 },
                 nil?: true

        # @!method initialize(enabled: nil, permission_policy: nil)
        #   Some parameter documentations has been truncated, see
        #   {Anthropic::Models::Beta::BetaManagedAgentsAgentToolsetDefaultConfigParams} for
        #   more details.
        #
