  ...
  module Models
    module Beta
      module BetaRawMessageStreamEvent
        ...
        #
        # @param type [Symbol, Anthropic::Models::Beta::BetaRawMessageStreamEvent::Type, String]
        #
        ...
        #
        #   @option args [Array<Anthropic::Models::Beta::BetaThinkingDroppedInputTransformation, Anthropic::Models::Beta::BetaThinkingMismatchAllowedInputTransformation>, nil] :input_transformations Changes the API made to the request's input before showing it to the model,
        #
