...
module Anthropic
  module Models
    module Beta
      ...
      # }
      # ```
      class BetaCitationCharLocation < Anthropic::BaseModel
        ...
        # @!attribute type
        #
        #   @return [Symbol, Anthropic::Models::Beta::BetaCitationCharLocation::Type]
        required :type, enum: -> { Anthropic::Models::Beta::BetaCitationCharLocation::Type }
