...
module Anthropic
  module Models
    module Beta
      class BetaComputerTripleClickConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerTripleClickConfig} for more details.
        #
    ...
    BetaComputerTripleClickConfig = Beta::BetaComputerTripleClickConfig
  end
end
