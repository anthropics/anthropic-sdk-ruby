    ...
    module Beta
      module Organization
        class BetaDataResidencyCreateConfig < Anthropic::Internal::Type::BaseModel
          ...
          #   details.
          #
          #   @param allowed_inference_geos [Symbol, :unrestricted, Array<Symbol, Anthropic::Models::Beta::Organization::BetaAllowedInferenceGeo>, nil] Permitted inference geo values. Defaults to 'unrestricted' if omitted, which all
          #
