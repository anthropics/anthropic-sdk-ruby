...
module Anthropic
  module Models
    module Beta
      class BetaComputerLeftMouseDownConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerLeftMouseDownConfig} for more details.
        #
    ...
    BetaComputerLeftMouseDownConfig = Beta::BetaComputerLeftMouseDownConfig
  end
end
