...
module Anthropic
  module Models
    module Beta
      class BetaComputerDoubleClickConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerDoubleClickConfig} for more details.
        #
    ...
    BetaComputerDoubleClickConfig = Beta::BetaComputerDoubleClickConfig
  end
end
