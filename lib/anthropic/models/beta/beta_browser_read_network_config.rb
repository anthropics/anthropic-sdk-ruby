...
module Anthropic
  module Models
    module Beta
      class BetaBrowserReadNetworkConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserReadNetworkConfig} for more details.
        #
    ...
    BetaBrowserReadNetworkConfig = Beta::BetaBrowserReadNetworkConfig
  end
end
