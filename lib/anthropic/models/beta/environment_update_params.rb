  ...
  module Models
    module Beta
      ...
      class EnvironmentUpdateParams < Anthropic::Internal::Type::BaseModel
        ...
        # @!method initialize(environment_id:, config: nil, description: nil, metadata: nil, name: nil, scope: nil, betas: nil, workspace_id: nil, request_options: {})
        ...
        module Config
          ...
          #
          # @param type [Symbol, Anthropic::Models::Beta::EnvironmentUpdateParams::Config::Type, String]
          #
