...
module Anthropic
  module Models
    module Beta
      class BetaBrowserZoomConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserZoomConfig} for more details.
        #
    ...
    BetaBrowserZoomConfig = Beta::BetaBrowserZoomConfig
  end
end
