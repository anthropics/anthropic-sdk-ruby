...
module Anthropic
  module Models
    module Beta
      class BetaComputerScrollConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerScrollConfig} for more details.
        #
    ...
    BetaComputerScrollConfig = Beta::BetaComputerScrollConfig
  end
end
