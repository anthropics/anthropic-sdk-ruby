...
module Anthropic
  module Models
    module Beta
      class BetaComputerWaitConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerWaitConfig} for more details.
        #
    ...
    BetaComputerWaitConfig = Beta::BetaComputerWaitConfig
  end
end
