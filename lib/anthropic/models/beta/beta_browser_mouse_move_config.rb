...
module Anthropic
  module Models
    module Beta
      class BetaBrowserMouseMoveConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserMouseMoveConfig} for more details.
        #
    ...
    BetaBrowserMouseMoveConfig = Beta::BetaBrowserMouseMoveConfig
  end
end
