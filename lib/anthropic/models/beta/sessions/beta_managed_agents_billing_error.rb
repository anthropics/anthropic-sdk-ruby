      ...
      module Sessions
        class BetaManagedAgentsBillingError < Anthropic::Internal::Type::BaseModel
          ...
          required :retry_status,
                   union: -> { Anthropic::Beta::Sessions::BetaManagedAgentsBillingError::RetryStatus }

          # @!attribute type
          #
          #   @return [Symbol, Anthropic::Models::Beta::Sessions::BetaManagedAgentsBillingError::Type]
          required :type, enum: -> { Anthropic::Beta::Sessions::BetaManagedAgentsBillingError::Type }
          ...
          #
          #   @param type [Symbol, Anthropic::Models::Beta::Sessions::BetaManagedAgentsBillingError::Type]

          # What the client should do next in response to this error.
          #
          # @see Anthropic::Models::Beta::Sessions::BetaManagedAgentsBillingError#retry_status
          module RetryStatus
            ...
            #
            # @param type [Symbol, Anthropic::Models::Beta::Sessions::BetaManagedAgentsBillingError::RetryStatus::Type, String]
            #
          ...
          # @see Anthropic::Models::Beta::Sessions::BetaManagedAgentsBillingError#type
          module Type
            extend Anthropic::Internal::Type::Enum
