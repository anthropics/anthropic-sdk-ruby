    ...
    module Beta
      module Sessions
        ...
        module BetaManagedAgentsSessionResource
          ...
          # {Anthropic::Models::Beta::Sessions::BetaManagedAgentsSessionResource} for more
          # details.
          #
          # @param type [Symbol, Anthropic::Models::Beta::Sessions::BetaManagedAgentsSessionResource::Type, String]
          #
