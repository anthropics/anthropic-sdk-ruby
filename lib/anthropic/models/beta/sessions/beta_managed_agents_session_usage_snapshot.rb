    ...
    module Beta
      module Sessions
        class BetaManagedAgentsSessionUsageSnapshot < Anthropic::Internal::Type::BaseModel
          ...
          #
          #   @param list_cost [Anthropic::Models::BetaMonetaryAmount] A monetary amount in a specific currency.
          #
          #   @param output_tokens [Integer] Total output tokens generated across all turns.
          #
          #   @param server_tool_use [Anthropic::Models::Beta::BetaManagedAgentsServerToolUsage] Cumulative count of server-executed tool invocations, broken down by tool.
        end
      end
    end
  end
