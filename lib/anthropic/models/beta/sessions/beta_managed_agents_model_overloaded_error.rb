      ...
      module Sessions
        class BetaManagedAgentsModelOverloadedError < Anthropic::Internal::Type::BaseModel
          ...
          required :retry_status,
                   union: -> { Anthropic::Beta::Sessions::BetaManagedAgentsModelOverloadedError::RetryStatus }

          # @!attribute type
          #
          #   @return [Symbol, Anthropic::Models::Beta::Sessions::BetaManagedAgentsModelOverloadedError::Type]
          required :type, enum: -> { Anthropic::Beta::Sessions::BetaManagedAgentsModelOverloadedError::Type }
          ...
          module RetryStatus
            ...
            #
            # @param type [Symbol, Anthropic::Models::Beta::Sessions::BetaManagedAgentsModelOverloadedError::RetryStatus::Type, String]
            #
          ...
          # @see Anthropic::Models::Beta::Sessions::BetaManagedAgentsModelOverloadedError#type
          module Type
            extend Anthropic::Internal::Type::Enum
