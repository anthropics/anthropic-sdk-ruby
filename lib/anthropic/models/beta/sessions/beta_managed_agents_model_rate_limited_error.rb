      ...
      module Sessions
        class BetaManagedAgentsModelRateLimitedError < Anthropic::Internal::Type::BaseModel
          ...
          required :retry_status,
                   union: -> { Anthropic::Beta::Sessions::BetaManagedAgentsModelRateLimitedError::RetryStatus }

          # @!attribute type
          #
          #   @return [Symbol, Anthropic::Models::Beta::Sessions::BetaManagedAgentsModelRateLimitedError::Type]
          required :type, enum: -> { Anthropic::Beta::Sessions::BetaManagedAgentsModelRateLimitedError::Type }
          ...
          #
          #   @param type [Symbol, Anthropic::Models::Beta::Sessions::BetaManagedAgentsModelRateLimitedError::Type]

          # What the client should do next in response to this error.
          #
          # @see Anthropic::Models::Beta::Sessions::BetaManagedAgentsModelRateLimitedError#retry_status
          module RetryStatus
            ...
            #
            # @param type [Symbol, Anthropic::Models::Beta::Sessions::BetaManagedAgentsModelRateLimitedError::RetryStatus::Type, String]
            #
          ...
          # @see Anthropic::Models::Beta::Sessions::BetaManagedAgentsModelRateLimitedError#type
          module Type
            extend Anthropic::Internal::Type::Enum
