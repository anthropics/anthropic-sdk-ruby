    ...
    module Beta
      module Sessions
        ...
        module ResourceUpdateResponse
          ...
          # {Anthropic::Models::Beta::Sessions::ResourceUpdateResponse} for more details.
          #
          # @param type [Symbol, Anthropic::Models::Beta::Sessions::ResourceUpdateResponse::Type, String]
          #
