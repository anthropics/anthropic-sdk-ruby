...
module Anthropic
  module Models
    module Beta
      class BetaBrowserScrollToConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaBrowserScrollToConfig} for more details.
        #
    ...
    BetaBrowserScrollToConfig = Beta::BetaBrowserScrollToConfig
  end
end
