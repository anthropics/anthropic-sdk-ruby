...
module Anthropic
  module Models
    module Beta
      class BetaComputerMouseMoveConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerMouseMoveConfig} for more details.
        #
    ...
    BetaComputerMouseMoveConfig = Beta::BetaComputerMouseMoveConfig
  end
end
