    ...
    module Beta
      class BetaManagedAgentsGlobToolConfig < Anthropic::Internal::Type::BaseModel
        ...
        required :permission_policy,
                 union: -> { Anthropic::Beta::BetaManagedAgentsGlobToolConfig::PermissionPolicy }

        # @!attribute type
        #
        #   @return [Symbol, :glob]
        required :type, const: :glob

        # @!method initialize(enabled:, permission_policy:, name: :glob, type: :glob)
        ...
        #
        #   @param name [Symbol, :glob]
        #
        #   @param type [Symbol, :glob]

        # Permission policy for tool execution.
        #
        # @see Anthropic::Models::Beta::BetaManagedAgentsGlobToolConfig#permission_policy
