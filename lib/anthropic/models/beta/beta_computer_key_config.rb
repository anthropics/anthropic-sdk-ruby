...
module Anthropic
  module Models
    module Beta
      class BetaComputerKeyConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerKeyConfig} for more details.
        #
    ...
    BetaComputerKeyConfig = Beta::BetaComputerKeyConfig
  end
end
