...
module Anthropic
  module Models
    module Beta
      class BetaComputerTypeConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerTypeConfig} for more details.
        #
    ...
    BetaComputerTypeConfig = Beta::BetaComputerTypeConfig
  end
end
