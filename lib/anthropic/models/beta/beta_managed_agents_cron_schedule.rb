  ...
  module Models
    module Beta
      class BetaManagedAgentsCronSchedule < Anthropic::Internal::Type::BaseModel
        ...
        # @!attribute type
        #
        #   @return [Symbol, Anthropic::Models::Beta::BetaManagedAgentsCronSchedule::Type]
        required :type, enum: -> { Anthropic::Beta::BetaManagedAgentsCronSchedule::Type }
        ...
        #
        #   @param type [Symbol, Anthropic::Models::Beta::BetaManagedAgentsCronSchedule::Type]
        #
        ...
        # @see Anthropic::Models::Beta::BetaManagedAgentsCronSchedule#type
        module Type
