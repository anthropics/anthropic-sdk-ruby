...
module Anthropic
  module Models
    module Beta
      class BetaComputerMiddleClickConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerMiddleClickConfig} for more details.
        #
    ...
    BetaComputerMiddleClickConfig = Beta::BetaComputerMiddleClickConfig
  end
end
