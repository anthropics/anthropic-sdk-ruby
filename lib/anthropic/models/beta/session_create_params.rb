  ...
  module Models
    module Beta
      ...
      class SessionCreateParams < Anthropic::Internal::Type::BaseModel
        ...
        #
        #   @return [Anthropic::Models::Beta::BetaManagedAgentsAgentParams, Anthropic::Models::Beta::BetaManagedAgentsAgentWithOverridesParams, String]
        ...
        # @!method initialize(agent:, environment_id:, budget: nil, initial_events: nil, metadata: nil, resources: nil, title: nil, vault_ids: nil, betas: nil, workspace_id: nil, request_options: {})
        #   Some parameter documentations has been truncated, see
        #   {Anthropic::Models::Beta::SessionCreateParams} for more details.
        #
        #   @param agent [Anthropic::Models::Beta::BetaManagedAgentsAgentParams, Anthropic::Models::Beta::BetaManagedAgentsAgentWithOverridesParams, String] Agent identifier. Accepts the `agent` ID string, which pins the latest version f
        #
        ...
        module Agent
          ...
          #   @return [Array(Anthropic::Models::Beta::BetaManagedAgentsAgentParams, Anthropic::Models::Beta::BetaManagedAgentsAgentWithOverridesParams, String)]
        end
        ...
        module InitialEvent
          ...
          #
          # @param type [Symbol, Anthropic::Models::Beta::SessionCreateParams::InitialEvent::Type, String]
          #
        ...
        module Resource
          ...
          #
          # @param type [Symbol, Anthropic::Models::Beta::SessionCreateParams::Resource::Type, String]
          #
          # @param args [Hash{Symbol=>Object}] Attributes for the chosen variant.
          #
