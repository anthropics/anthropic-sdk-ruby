  ...
  module Models
    module Beta
      class BetaImageTransformationsParam < Anthropic::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Anthropic::Models::Beta::BetaImageTransformationsParam::OversizedImage, nil]
        optional :oversized_image, enum: -> { Anthropic::Beta::BetaImageTransformationsParam::OversizedImage }
        ...
        #   {Anthropic::Models::Beta::BetaImageTransformationsParam} for more details.
        #
        #   @param oversized_image [Symbol, Anthropic::Models::Beta::BetaImageTransformationsParam::OversizedImage] What the server does when this image exceeds the model's maximum image size. `"d
        ...
        # never silently scaled down.
        #
        # @see Anthropic::Models::Beta::BetaImageTransformationsParam#oversized_image
