...
module Anthropic
  module Models
    module Beta
      class BetaComputerZoomConfig < Anthropic::Internal::Type::BaseModel
        ...
        #   {Anthropic::Models::Beta::BetaComputerZoomConfig} for more details.
        #
    ...
    BetaComputerZoomConfig = Beta::BetaComputerZoomConfig
  end
end
