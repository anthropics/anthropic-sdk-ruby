...
module Anthropic
  module Models
    module RawMessageStreamEvent
      ...
      #
      # @param type [Symbol, Anthropic::Models::RawMessageStreamEvent::Type, String]
      #
