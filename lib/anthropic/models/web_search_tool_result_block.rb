...
module Anthropic
  module Models
    class WebSearchToolResultBlock < Anthropic::Internal::Type::BaseModel
      ...
      #
      #   @return [Anthropic::Models::DirectCaller, Anthropic::Models::ServerToolCaller, Anthropic::Models::WebSearchToolResultBlock::Caller::CodeExecution20260120]
      ...
      #   @param caller_ [Anthropic::Models::DirectCaller, Anthropic::Models::ServerToolCaller, Anthropic::Models::WebSearchToolResultBlock::Caller::CodeExecution20260120] Tool invocation directly from the model.
      #
      ...
      module Caller
        ...
        #   @return [Array(Anthropic::Models::DirectCaller, Anthropic::Models::ServerToolCaller, Anthropic::Models::WebSearchToolResultBlock::Caller::CodeExecution20260120)]
      end
    end
  end
end
