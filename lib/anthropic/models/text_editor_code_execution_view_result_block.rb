...
module Anthropic
  module Models
    class TextEditorCodeExecutionViewResultBlock < Anthropic::Internal::Type::BaseModel
      ...
      # @!attribute file_type
      #
      #   @return [Symbol, Anthropic::Models::TextEditorCodeExecutionViewResultBlock::FileType]
      required :file_type, enum: -> { Anthropic::TextEditorCodeExecutionViewResultBlock::FileType }
      ...
      #   @param file_type [Symbol, Anthropic::Models::TextEditorCodeExecutionViewResultBlock::FileType]
      ...
      # @see Anthropic::Models::TextEditorCodeExecutionViewResultBlock#file_type
      module FileType
