...
module Anthropic
  module Models
    class WebSearchTool20260318 < Anthropic::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Symbol, Anthropic::Models::WebSearchTool20260318::AllowedCaller>, nil]
      ...
      #
      #   @return [Symbol, Anthropic::Models::WebSearchTool20260318::ResponseInclusion, nil]
      ...
      #   {Anthropic::Models::WebSearchTool20260318} for more details.
      #
      #   @param allowed_callers [Array<Symbol, Anthropic::Models::WebSearchTool20260318::AllowedCaller>]
      #
      ...
      #
      #   @param response_inclusion [Symbol, Anthropic::Models::WebSearchTool20260318::ResponseInclusion] How this tool's result blocks appear in the API response when the result was con
      #
      ...
      # sent back on the next turn.
      #
      # @see Anthropic::Models::WebSearchTool20260318#response_inclusion
