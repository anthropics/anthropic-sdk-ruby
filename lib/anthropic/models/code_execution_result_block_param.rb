...
module Anthropic
  module Models
    class CodeExecutionResultBlockParam < Anthropic::Internal::Type::BaseModel
      # @!attribute content
      #
      #   @return [Array<Anthropic::Models::CodeExecutionOutputBlockParam>]
      required :content, -> { Anthropic::Internal::Type::ArrayOf[Anthropic::CodeExecutionOutputBlockParam] }
      ...
      #   @param content [Array<Anthropic::Models::CodeExecutionOutputBlockParam>]
