...
module Anthropic
  module Models
    class ToolUseBlockParam < Anthropic::Internal::Type::BaseModel
      ...
      #
      #   @return [Anthropic::Models::DirectCaller, Anthropic::Models::ServerToolCaller, Anthropic::Models::ToolUseBlockParam::Caller::CodeExecution20260120, nil]
      ...
      #
      #   @param caller_ [Anthropic::Models::DirectCaller, Anthropic::Models::ServerToolCaller, Anthropic::Models::ToolUseBlockParam::Caller::CodeExecution20260120] Tool invocation directly from the model.
      #
      #   @param type [Symbol, :tool_use]

      # Tool invocation directly from the model.
      #
      # @see Anthropic::Models::ToolUseBlockParam#caller_
      module Caller
        ...
        variant :code_execution_20260120, -> { Anthropic::ToolUseBlockParam::Caller::CodeExecution20260120 }
        ...
        #   @return [Array(Anthropic::Models::DirectCaller, Anthropic::Models::ServerToolCaller, Anthropic::Models::ToolUseBlockParam::Caller::CodeExecution20260120)]
      end
    end
  end
end
