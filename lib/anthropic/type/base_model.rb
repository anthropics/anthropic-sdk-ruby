...
module Anthropic
  module Type
    ...
    #   }
    class BaseModel
      extend Anthropic::Type::Converter
      ...
      class << self
        ...
        #
        # @param type_info [Hash{Symbol=>Object}, Proc, Anthropic::Type::Converter, Class]
        #
        ...
        private def add_field(name_sym, required:, type_info:, spec:)
          type_fn, info =
            case type_info
            in Proc | Anthropic::Type::Converter | Class
              [Anthropic::Type::Converter.type_info({**spec, union: type_info}), spec]
            in Hash
              [Anthropic::Type::Converter.type_info(type_info), type_info]
            end
          ...
          define_method(name_sym) do
            ...
            if (nilable || !required) && value.nil?
              ...
              Anthropic::Type::Converter.coerce(
                target,
                value,
                state: state
              )
          ...
          fields.each do |name, field|
            ...
            converted =
              if item.nil? && (nilable || !required)
                ...
                coerced = Anthropic::Type::Converter.coerce(target, item, state: state)
                case target
                in Anthropic::Type::Converter | Symbol
                  coerced
                else
                  item
                end
          ...
          coerced.each do |key, val|
            ...
            in nil
              ...
              in :coerce
                ...
                target = type_fn.call
                acc.store(api_name, Anthropic::Type::Converter.dump(target, val))
              end
            end
          end
