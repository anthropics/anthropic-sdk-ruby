    ...
    module Converter
      ...
      class << self
        ...
        def type_info(spec)
          ...
          in Anthropic::Type::Converter | Class | Symbol
            -> { spec }
        ...
        #
        # @param target [Anthropic::Type::Converter, Class]
        #
        # @param value [Object]
        #
        ...
        def dump(target, value)
          target.is_a?(Anthropic::Type::Converter) ? target.dump(value) : Anthropic::Unknown.dump(value)
        end
      end
    end
  end
