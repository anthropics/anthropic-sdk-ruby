...
module Anthropic
  ...
  module Converter
    ...
    class << self
      ...
      def type_info(spec)
        ...
        in Proc
          spec
        in Anthropic::Converter | Module | Symbol
          -> { spec }
        in true | false
  ...
  module Enum
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class.ancestors.include?(Anthropic::Enum) && other.values.to_set == values.to_set
    end
  ...
  module Union
    ...
    private def variant(key, spec = nil)
      variant_info =
        ...
        in Proc | Anthropic::Converter | Module | Hash
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class.ancestors.include?(Anthropic::Union) && other.derefed_variants == derefed_variants
    end
  ...
  class ArrayOf
    ...
    def coerce(value)
      ...
      in Enumerable unless value.is_a?(Hash)
        value.map { Anthropic::Converter.coerce(type, _1) }
      else
        value
      end
    end
    ...
    def dump(value)
      ...
      case value
      in Enumerable unless value.is_a?(Hash)
        value.map { Anthropic::Converter.dump(type, _1) }.to_a
      else
        value
      end
    end
  ...
  class BaseModel
    ...
    class << self
      ...
      def reverse_map
        @reverse_map ||= (self < Anthropic::BaseModel ? superclass.reverse_map.dup : {})
      end
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        type_fn, info =
          case type_info
          in Proc | Module | Anthropic::Converter
    ...
    class << self
      ...
      def coerce(value)
        case Anthropic::Util.coerce_hash(value)
        in Hash => coerced
          new(coerced)
        else
          value
    ...
    def initialize(data = {})
      ...
      in Hash => coerced
        @data = coerced.to_h do |key, value|
          ...
          stored =
            case [type, value]
            in [Module, Hash] if type <= Anthropic::BaseModel
              type.new(value)
            in [Anthropic::ArrayOf, Array] | [Anthropic::HashOf, Hash]
              type.coerce(value)
            else
              value
            end
