...
module Anthropic
  ...
  module Converter
    ...
    class << self
      ...
      def type_info(spec)
        ...
        in Anthropic::Converter | Class | Symbol
          -> { spec }
      ...
      def dump(target, value)
        target.is_a?(Anthropic::Converter) ? target.dump(value) : Anthropic::Unknown.dump(value)
      end
    end
  end
  ...
  module Enum
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class <= Anthropic::Enum && other.values.to_set == values.to_set
    end
  ...
  module Union
    ...
    # @api private
    #
    # @param key [Symbol, Hash{Symbol=>Object}, Proc, Anthropic::Converter, Class]
    #
    # @param spec [Hash{Symbol=>Object}, Proc, Anthropic::Converter, Class] .
    #
    #   @option spec [NilClass, TrueClass, FalseClass, Integer, Float, Symbol] :const
    ...
    private def resolve_variant(value)
      ...
      in [Symbol, Hash]
        key = value.fetch(@discriminator) do
          value.fetch(@discriminator.to_s, Anthropic::Util::OMIT)
        end

        return nil if key == Anthropic::Util::OMIT
    ...
    def coerce(value, state:)
      if (target = resolve_variant(value))
        return Anthropic::Converter.coerce(target, value, state: state)
      end
      ...
      known_variants.each do |_, variant_fn|
        ...
        coerced = Anthropic::Converter.coerce(target, value, state: state)
    ...
    def dump(value)
      if (target = resolve_variant(value))
        return Anthropic::Converter.dump(target, value)
      end

      known_variants.each do
        target = _2.call
        return Anthropic::Converter.dump(target, value) if target === value
      end
  ...
  class ArrayOf
    ...
    # @param type_info [Hash{Symbol=>Object}, Proc, Anthropic::Converter, Class]
    #
    ...
    #
    # @return [Boolean]
    def ==(other) = other.is_a?(Anthropic::ArrayOf) && other.nilable? == nilable? && other.item_type == item_type
      ...
      value
        .map do |item|
          ...
          in [true, nil]
            ...
            Anthropic::Converter.coerce(target, item, state: state)
          end
        end
    end
    ...
    def dump(value)
      target = item_type
      value.is_a?(Array) ? value.map { Anthropic::Converter.dump(target, _1) } : super
    end

    # @api private
    #
    # @return [Anthropic::Converter, Class]
  ...
  class HashOf
    ...
    #
    # @return [Boolean]
    def ==(other) = other.is_a?(Anthropic::HashOf) && other.nilable? == nilable? && other.item_type == item_type
        ...
        .to_h do |key, val|
          ...
          v =
            ...
            in [true, nil]
              ...
              Anthropic::Converter.coerce(target, val, state: state)
            end
    ...
    def dump(value)
      target = item_type
      value.is_a?(Hash) ? value.transform_values { Anthropic::Converter.dump(target, _1) } : super
    end
  ...
  class BaseModel
    ...
    class << self
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        type_fn, info =
          case type_info
          in Proc | Anthropic::Converter | Class
        ...
        nilable = info[:nil?]
        const = required && !nilable ? info.fetch(:const, Anthropic::Util::OMIT) : Anthropic::Util::OMIT
        ...
        define_method(name_sym) do
          target = type_fn.call
          value = @data.fetch(name_sym) { const == Anthropic::Util::OMIT ? nil : const }
          state = {strictness: :strong, exactness: {yes: 0, no: 0, maybe: 0}, branched: 0}
          if (nilable || !required) && value.nil?
            nil
          else
            Anthropic::Converter.coerce(
              target,
              value,
              state: state
            )
    ...
    class << self
      ...
      def coerce(value, state:)
        ...
        unless (val = Anthropic::Util.coerce_hash(value)).is_a?(Hash)
          exactness[:no] += 1
          return value
        end
        exactness[:yes] += 1
        ...
        fields.each do |name, field|
          ...
          converted =
            if item.nil? && (nilable || !required)
              ...
              coerced = Anthropic::Converter.coerce(target, item, state: state)
              case target
              in Anthropic::Converter | Symbol
                coerced
              else
                item
              end
      ...
      def dump(value)
        ...
        coerced.each do |key, val|
          ...
          in nil
            ...
            in :coerce
              ...
              target = type_fn.call
              acc.store(api_name, Anthropic::Converter.dump(target, val))
            end
          end
        end
        ...
        known_fields.each_value do |field|
          ...
          next if mode == :coerce || acc.key?(api_name) || const == Anthropic::Util::OMIT
    ...
    def initialize(data = {})
      case Anthropic::Util.coerce_hash(data)
      in Hash => coerced
        @data = coerced
      else
    ...
    def inspect
      ...
      rescue Anthropic::ConversionError
        "#{_1}=#{@data.fetch(_1)}"
      end
