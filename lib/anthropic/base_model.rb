...
module Anthropic
  ...
  module Converter
    # @private
    # @param spec [Proc, Class, Anthropic::Converter, Hash]
    #
    # @return [Proc]
    #
    ...
    #
    # @param target [Class, Anthropic::Converter]
    # @param value [Object]
    #
    # @return [Object]
    #
  ...
  class Union
    ...
    # @private
    #
    # @param key [Symbol, Anthropic::Converter, Proc]
    # @param variant [Proc, Object]
    # @param key [Symbol, nil]
    #
    # @return [void]
    ...
    private_class_method def self.variant(key = nil, type_info = nil, enum: nil, union: nil)
      variant_info =
        ...
        in [Proc, nil, nil, nil]
          [nil, key]
        in [Class | Anthropic::Converter, nil, nil, nil]
          [nil, -> { key }]
        in [Symbol, Proc, nil, nil]
          [key, type_info]
        in [Symbol, Class | Anthropic::Converter, nil, nil]
          [key, -> { type_info }]
  ...
  class ArrayOf
    ...
    def initialize(spec = {})
      @items_type_fn = Anthropic::Converter.type_info(spec)
    end
  end
    ...
    def coerce(value)
      ...
      in Hash
        value.to_h do |key, val|
          coerced = Anthropic::Converter.coerce(items_type, val)
    ...
    def dump(value)
      ...
      in Hash
        value.transform_values do |val|
          Anthropic::Converter.dump(items_type, val)
        end
      else
        value
      end
  ...
  class BaseModel
    ...
    private_class_method def self.add_field(name_sym, required:, type_info:, spec:)
      type_fn, api_name =
        ...
        in Proc | Class | Anthropic::Converter
          [Anthropic::Converter.type_info({**spec, union: type_info}), spec[:api_name]]
        in Hash
          [Anthropic::Converter.type_info(type_info), type_info[:api_name]]
        end
    ...
    # @param data [Hash{Symbol => Object}, Anthropic::BaseModel] Raw data to initialize the model with.
    #
    def initialize(data = {})
