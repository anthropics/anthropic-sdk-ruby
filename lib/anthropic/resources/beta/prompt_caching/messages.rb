    ...
    class Beta
      class PromptCaching
        class Messages
          ...
          #   @option params [String, Symbol, Anthropic::Models::Model::UnnamedTypeWithunionParent21] :model Body param: The model that will complete your prompt.\n\nSee
          ...
          #     Recommended for advanced use cases only. You usually only need to use
          #     `temperature`.
          #   @option params [Array<String, Symbol, Anthropic::Models::AnthropicBeta::UnnamedTypeWithunionParent22>, nil] :betas Header param: Optional header to specify the beta version(s) you want to use.
          #
