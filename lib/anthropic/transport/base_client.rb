...
module Anthropic
  module Transport
    ...
    class BaseClient
      ...
      # @api private
      # @return [Anthropic::Transport::PooledNetRequester]
      ...
      def initialize(
        ...
        @requester = Anthropic::Transport::PooledNetRequester.new
      ...
      #
      #   @option req [Anthropic::Type::Converter, Class, nil] :model
      #
      ...
      private def build_request(req, opts)
        ...
        query = Anthropic::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
      ...
      private def send_request(request, redirect_count:, retry_count:, send_retry_header:)
        ...
        in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: response)
          decoded = Kernel.then do
            Anthropic::Util.decode_content(response, stream: stream, suppress_error: true)
          ensure
            self.class.reap_connection!(status, stream: stream)
          end
      ...
      def request(req)
        ...
        in { page: Class => page }
          ...
          Anthropic::Type::Converter.coerce(model, unwrapped)
        end
      end
