...
class Anthropic::Test::PrimitiveModelTest < Minitest::Test
  A = Anthropic::Internal::Type::ArrayOf[-> { Integer }]
  H = Anthropic::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Anthropic::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Anthropic::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Anthropic::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Anthropic::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Anthropic::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        Anthropic::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Anthropic::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Anthropic::Internal::Type::Boolean, true] => true,
      [Anthropic::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Anthropic::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Anthropic::Internal::Type::Converter.new_coerce_state
      Anthropic::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Anthropic::Internal::Type::Converter.dump(target, input, state: state)
...
class Anthropic::Test::CollectionModelTest < Minitest::Test
  A1 = Anthropic::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Anthropic::Internal::Type::HashOf[Integer]

  A2 = Anthropic::Internal::Type::ArrayOf[H1]
  H2 = Anthropic::Internal::Type::HashOf[-> { A1 }]

  A3 = Anthropic::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Anthropic::Internal::Type::HashOf[Integer, nil?: true]
...
class Anthropic::Test::BaseModelTest < Minitest::Test
  ...
  class M3 < Anthropic::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Anthropic::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Anthropic::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        ...
        if coerced.is_a?(Anthropic::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
...
class Anthropic::Test::UnionTest < Minitest::Test
  ...
  class M2 < Anthropic::Internal::Type::BaseModel
  ...
  class M4 < Anthropic::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Anthropic::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Anthropic::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Anthropic::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Anthropic::Test::MetaInfoTest < Minitest::Test
  A1 = Anthropic::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Anthropic::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
